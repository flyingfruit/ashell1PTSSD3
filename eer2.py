...
def prepare(rate=0.2):
    ...
    os.system('cd /media/dream/新加卷/pldaTry/ && /media/dream/新加卷/pldaTry/enroll3.sh')
...
if __name__ == '__main__':
    ...
    with open(saveDIR + '/' + 'scoreforeer2', 'w') as score_t:
        with open(scoreDir + '/' + 'scores2', 'r') as f2:
            line = f2.readline()
            while (line):
                # [m,n,score]=f2.readline().split()
                [m, n, score] = line.split()
    ...
    os.system(". /media/dream/新加卷/pldaTry/path.sh && compute-eer %s" % (saveDIR + '/' + 'scoreforeer2'))
